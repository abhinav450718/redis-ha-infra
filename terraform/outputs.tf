...
output "ssh_to_bastion" {
  value = "ssh -i ${path.module}/redis_key.pem ubuntu@${module.bastion.bastion_public_ip}"
}

output "ssh_to_redis_master_via_bastion" {
  value = "ssh -i ${path.module}/redis_key.pem -J ubuntu@${module.bastion.bastion_public_ip} ubuntu@${module.redis_master.private_ip}"
}

output "ssh_to_redis_replica_via_bastion" {
  value = "ssh -i ${path.module}/redis_key.pem -J ubuntu@${module.bastion.bastion_public_ip} ubuntu@${module.redis_replica.private_ip}"
}
